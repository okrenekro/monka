...
```mermaid
flowchart LR
    P19(("1-Eigenvektor / Stat. Vert."))
    A1["A1 isolierter Knoten"]
    A2["A2 G⊗H Tensor"]
    A3["A3 Spektral-Iso-Inv."]
    A4["A4 L-Eigenvektor"]
    A5["A5 σ ∈ Aut(G)"]
    A6["A6 xᵀLx Graph-Energie"]
    A7["A7 Σdeg(v) Gradsumme"]
    A8["A8 L=Lᵀ"]
    A9["A9 |V|=n"]
    A10["A10 Spektral-Vielfachheit"]
    A11["A11 ⟨f,g⟩=Σf(v)g(v)"]
    A12["A12 (sI−L)⁻¹ Green-Mtx"]
    A13["A13 rang(L)/(n−1)"]
    A14["A14 Σvᵢvᵢᵀ=I"]
