...
flowchart LR
    P19(("Stab. GG-Bahn"))
    A1["A1 Erhaltungsgröße [H,·]=0"]
    A2["A2 H_AB Koppel-Hamiltonian"]
    A3["A3 sympl. Invariante"]
    A4["A4 Aktion I_k"]
    A5["A5 kanon. Transformation"]
    A6["A6 ½pᵀM⁻¹p kin. Energie"]
    A7["A7 ∇·v=0 Liouville"]
    A8["A8 M=Mᵀ (Massematrix)"]
    A9["A9 f Freiheitsgrade"]
    A10["A10 Resonante Tori"]
    A11["A11 ω(X,Y)=∫p_i dq^i"]
    A12["A12 Green-Operator"]
    A13["A13 Tori-Maß / Aktion-Dichte"]
    A14["A14 Aktion-Winkel-Basis"]
